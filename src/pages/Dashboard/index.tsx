      ...
      <Container>
        <CardContainer>
          <Card>
            ...
            <h1 data-testid="balance-income">{parsedBalance.income}</h1>
          </Card>
          <Card>
            <header>
              <p>Saídas</p>
            ...
            <h1 data-testid="balance-outcome">{parsedBalance.outcome}</h1>
          </Card>
          <Card total>
            <header>
              <p>Total</p>
            ...
            <h1 data-testid="balance-total">{parsedBalance.total}</h1>
          </Card>
        </CardContainer>
